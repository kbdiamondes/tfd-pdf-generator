...
function tfcap_get_nff_template() {
  ...
  "fields": [
    ...
    {"id":53,"key":"sectiondiv_53","type":"sectiondiv","label":"9. Directors\' Guarantee and Indemnity","order":52,"required":0,"default":"","label_pos":"above","personally_identifiable":0},
    {"id":54,"key":"html_54","type":"html","label":"","order":53,"required":0,"default":"<p>In consideration of The Fun Depot agreeing to provide credit terms, we personally guarantee payment of all money owing.</p>","label_pos":"hidden","personally_identifiable":0},
    {"id":55,"key":"textbox_55","type":"textbox","label":"Guarantor Full Name","order":54,"required":0,"default":"","label_pos":"above","personally_identifiable":1,"placeholder":"Guarantor Name"},
    {"id":56,"key":"textbox_56","type":"textbox","label":"Relationship to Applicant (e.g. Director)","order":55,"required":0,"default":"","label_pos":"above","personally_identifiable":0,"placeholder":"e.g. Director"},
    {"id":57,"key":"textbox_57","type":"textbox","label":"Guarantor Residential Address","order":56,"required":0,"default":"","label_pos":"above","personally_identifiable":1,"placeholder":"Residential Address"},
    {"id":58,"key":"signature_58","type":"signature","label":"Guarantor Signature","order":57,"required":1,"default":"","label_pos":"above","personally_identifiable":0,"signature_method":"drawn","signature_font":"dancing-script","drawn_placeholder":"Sign here","canvas_width":1000,"canvas_height":400,"pen_color":"#000000","background_color":"#ffffff"},
    {"id":59,"key":"checkbox_59","type":"checkbox","label":"I/We have read, understood and agree to the Directors\' Guarantee","order":58,"required":1,"default":"unchecked","label_pos":"right","personally_identifiable":0,"checked_value":"I / We Agree","unchecked_value":"","checked_calc_value":"1","unchecked_calc_value":"0"},
    {"id":60,"key":"submit_60","type":"submit","label":"Submit Credit Application","order":59,"required":0,"default":"","label_pos":"above","personally_identifiable":0,"processing_label":"Processing..."}
  ],
  "actions": [
